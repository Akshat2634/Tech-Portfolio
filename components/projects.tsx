...
const techColors: Record<string, string> = {
  ...
  "OpenAI Realtime API":  "bg-primary/10 text-primary border-primary/20",
  ...
  "Prisma ORM":           "bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border-indigo-500/20",
  "Supabase Storage":     "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20",
  "Supabase":             "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20",
  "OCR":                  "bg-pink-500/10 text-pink-600 dark:text-pink-400 border-pink-500/20",
  ...
  "Express":              "bg-zinc-500/10 text-zinc-600 dark:text-zinc-400 border-zinc-500/20",
  ...
  "Mongoose":             "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20",
  "ElasticEmail":         "bg-sky-500/10 text-sky-600 dark:text-sky-400 border-sky-500/20",
  "bcrypt":               "bg-amber-500/10 text-amber-600 dark:text-amber-400 border-amber-500/20",
...
function CliBlock() {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("npx codelens-ai").then(() => {
      track("cli_copy", { command: "npx codelens-ai", project: "CodeLens AI" })
      setCopied(true)
...
export default function Projects() {
  const projects = [
    ...
    {
      title: "PitchPilot",
      tagline: "AI-Powered Investor Pitch Analyzer & Coach" as string | undefined,
      ...
      technologies: ["FastAPI", "LangGraph", "OpenAI Realtime API", "PostgreSQL", "Prisma", "Supabase Storage"],
